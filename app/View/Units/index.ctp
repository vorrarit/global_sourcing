...
<div class="units index">
    ...
    <div class="btn-group pull-right" role="group" aria-label="...">
		<?php echo $this->Form->button('<span class="glyphicon glyphicon-pencil"></span>', array('onclick'=>"window.location.href='../Units/add'",'type'=>'button','escape'=>false, 'title'=>__('Add'),'class'=>'btn btn-default')); ?>
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th width="300"><?php echo $this->Paginator->sort('id','Unit ID'); ?></th>
                <th width="300"><?php echo $this->Paginator->sort('unit_name'); ?></th>
