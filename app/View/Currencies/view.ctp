...
<div class="related">
	...
	<?php foreach ($currency['Product'] as $product): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($currency['SupplierProduct'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<?php foreach ($currency['SupplierProduct'] as $supplierProduct): ?>
		<tr>
