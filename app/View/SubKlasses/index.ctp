<div class="subKlasses form">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><?php echo __('Search SubClasses'); ?></h1>
        </div>
    </div>
<?php echo $this->Form->create('subKlasses',array('action'=>'index')); ?>
    <fieldset>  
        <?php
...
<div class="subKlasses index">
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th width="150"><?php echo $this->Paginator->sort('klass_id'); ?></th>
                <th><?php echo $this->Paginator->sort('sub_klass_name'); ?></th>
	...
	<?php foreach ($subKlasses as $subKlass): ?>
            <tr>
                ...
                <td><?php echo h($subKlass['SubKlass']['klass_id']); ?>&nbsp;</td>
			...
			<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-trash"></span>', array('action' => 'delete', $subKlass['SubKlass']['id']), array('escape'=>false, 'title'=>__('Delete')), __('Are you sure you want to delete # %s?', $subKlass['SubKlass']['id'])); ?>
                </td>
            </tr>
<?php endforeach; ?>
        </tbody>
